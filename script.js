...
class Game {
    ...
    spawnMonster() {
        ...
        this.log(isBoss ? "きょうだいな ボス が あらわれた！" : `Lv.${this.level} の モンスター が あらわれた！`);
    }
    ...
    onCorrectAnswer() {
        ...
        this.log(`せいかい！ ${speedBonus}点ボーナス！`);
        this.log(`${damage} のダメージ を あたえた！`);
    ...
    onWrongAnswer(wrongVal) {
        ...
        this.log(`ざんねん... せいかいは ${this.currentProblem.answer} だ。`);
        this.log(`勇者 は ${damage} のダメージ を うけた！`);
        ...
        if (this.monster.hp <= 0) {
            ...
            setTimeout(() => {
                ...
                if (this.level >= 10) {
                    ...
                    this.log("モンスター を たおした！");
                    this.levelUp();
                }
            }, 1000);
        } else if (this.hero.hp <= 0) {
            // Lose
            this.log("勇者 は たおれてしまった...");
            this.playSound('wrong');
            setTimeout(() => {
